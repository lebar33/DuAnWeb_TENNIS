...
if(isPost()){
   ...
   if(empty($error)){
      ...
      if($insertStatus){
         setFlashData('smg', 'Sửa người dùng mới thành công!');  
...
<div class="container">
   <div class="row" style="margin:50px auto">
      ...
      <form action="" method="post" >
         ...
         <a href="?module=users&action=list" type="submit" class="btn-user mg-btn btn btn-success btn-block">Quay lại</a><hr>
      </form>
   </div>
</div>

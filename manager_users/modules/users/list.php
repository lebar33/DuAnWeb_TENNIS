...
<div class="container">
   ...
   <table class="table table-bordered">
      ...
      <tr>
         ...
         <td><a href="?module=users&action=delete&id=<?php echo $item['id']; ?>" onclick="confirm('Bạn có chắc chắn muốn xóa')" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a></td><!--xóa-->
      </tr>
      <?php
            endforeach;
         else: 

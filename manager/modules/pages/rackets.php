...
$listProductRacket = getRaw("SELECT * FROM products WHERE categoryId = 1");
if(empty($listProductRacket)):
?>
...
<section class="Hot-product-list p-to-top">
    <div class="container" >
        <div class="row-flex row-flex-product">
            <p class="heading-text-1">VỢT</p> 
        </div>
        <div class="row-grid row-grid-products">
<?php
    foreach($listProductRacket as $item):
?>
